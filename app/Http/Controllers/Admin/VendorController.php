...
class VendorController extends Controller
{
    ...
    {
        $vendors = Vendor::selection()->paginate(PAGNATION_COUNT);
    ...
    public function edit($id)
    {
        try {
            ...
            if (!$vendor & !$categories)
                return redirect()->route('admin.vendors')->with(['error' => 'هذة  غير موجودة']);


            return view('admin.vendors.ubdate', compact('vendor', 'categories'));
        } catch (Exception $exp) {
