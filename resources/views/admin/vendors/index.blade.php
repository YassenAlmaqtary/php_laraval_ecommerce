    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">  جميع المتاجر </h3>
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($vendors as $vendor)  
                                                <tr>
                                                    <td>{{$vendor->name}}</td>
                                                    <td><img style="width: 150px; height: 100px;" src="{{get_url_image($vendor->logo)}}"></td>
                                                    <td>{{$vendor->mobile}}</td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group"
                                                            ...
                                                            <form id="form" action="{{route('admin.vendors.delete',$vendor->id)}}" method="POST" class="d-none">
                                                                @method('delete')
                                                                @csrf
                                                            </form>
