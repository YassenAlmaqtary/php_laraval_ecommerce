                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.cstegorys')}}"> الاقسام الرئيسية </a>
                            </li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form"
                                          action="{{route('admin.cstegorys.update',$mainCategory->id)}}"
                                          method="POST"
                                        ...
                                        <div class="form-group">
                                            <div class="text-center">
                                                <img
                                                    src="{{get_url_image($mainCategory->photo)}}"
                                    ...
                                    <ul class="nav nav-tabs">
                                        @isset($mainCategory->categorys)
                                            @foreach($mainCategory ->categorys as $index => $translation)
                                                <li class="nav-item">
                                      ...
                                      <div class="tab-content px-1 pt-1">
                                        ...
                                        @isset($mainCategory->categorys)
                                            ...
                                            <form class="form"
                                                  action="{{route('admin.cstegorys.update',$translation -> id)}}"
                                                  method="POST"
                                                  enctype="multipart/form-data"> 
