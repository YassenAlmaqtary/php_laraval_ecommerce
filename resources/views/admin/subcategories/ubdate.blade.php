                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.sub-cstegorys')}}"> الاقسام الفرعية </a>
                            </li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form"
                                          action="{{route('admin.sub-cstegorys.update',$SubCategory->id)}}"
                                          method="POST"
                                        ...
                                        <div class="form-group">
                                            <div class="text-center">
                                                <img
                                                    src="{{get_url_image($SubCategory->photo)}}"
                                    ...
                                    <ul class="nav nav-tabs">
                                        @isset($SubCategory->categorys)
                                            @foreach($SubCategory ->categorys as $index => $translation)
                                                <li class="nav-item">
                                      ...
                                      <div class="tab-content px-1 pt-1">
                                        ...
                                        @isset($SubCategory->categorys)
                                            ...
                                            <form class="form"
                                                  action="{{route('admin.sub-cstegorys.update',$translation -> id)}}"
                                                  method="POST"
                                                  enctype="multipart/form-data"> 
